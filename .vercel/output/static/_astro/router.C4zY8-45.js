const p = "data-astro-transition-persist";
function _(t) {
...
const W = () => {
  ...
  V = (t) => {
    _(t), $(t), q(t);
    const e = W();
    B(t.body, document.body), e();
  },
  K = "astro:before-preparation",
  z = "astro:after-preparation",
  G = "astro:before-swap",
  J = "astro:after-swap",
  Q = (t) => document.dispatchEvent(new Event(t));
class N extends Event {
  ...
  newDocument;
  signal;
  constructor(e, n, o, r, i, u, a, l, d, c) {
    super(e, n),
      (this.from = o),
      (this.to = r),
      (this.direction = i),
...
class Z extends N {
  ...
  loader;
  constructor(e, n, o, r, i, u, a, l, d, c) {
    super(K, { cancelable: !0 }, e, n, o, r, i, u, a, l),
      (this.formData = d),
...
async function et(t, e, n, o, r, i, u, a, l) {
  const d = new Z(t, e, n, o, r, i, window.document, u, a, l);
  return (
    document.dispatchEvent(d) &&
      (await d.loader(),
      d.defaultPrevented ||
        (Q(z), d.navigationType !== "traverse" && R({ scrollX, scrollY }))),
    d
  );
}
function nt(t, e) {
...
const ot = history.pushState.bind(history),
  ...
  F = (t, e) => t.pathname === e.pathname && t.search === e.search;
let f, b, g;
...
const H = (t, e, n, o, r) => {
  ...
  if (t.href !== location.href && !r)
    ...
    } else ot({ ...n.state, index: ++T, scrollX: 0, scrollY: 0 }, "", t.href);
  if (
    ((document.title = u),
    (g = t),
    ...
    if (t.hash) {
      ...
      (location.href = t.href),
        history.state ||
          (v(l, ""), i && window.dispatchEvent(new PopStateEvent("popstate")));
...
async function k(t, e, n, o, r) {
  async function i(l) {
    ...
    const w = document.getAnimations().filter((h) => !c.includes(h) && !d(h));
...
async function M(t, e, n, o, r) {
  ...
  if (
    ...
    F(e, n) && ((t !== "back" && n.hash) || (t === "back" && e.hash)))
  ) {
    H(n, e, o, document.title, r), i === f && (f = void 0);
    return;
  }
  const a = await et(
    e,
  ...
  async function l(s) {
    ...
    if (
      ((I ??= new DOMParser()),
      (s.newDocument = I.parseFromString(m.html, m.mediaType)),
  ...
  if ((document.documentElement.setAttribute(D, a.direction), O))
    c.viewTransition = document.startViewTransition(
      async () => await k(a, o, c, r),
    );
  else {
    const s = (async () => {
      await Promise.resolve(), await k(a, o, c, r, C());
    })();
    c.viewTransition = {
      ...
      skipTransition: () => {
        (c.transitionSkipped = !0), document.documentElement.removeAttribute(S);
      },
    };
  }
...
async function ut(t, e) {
  await M("forward", g, new URL(t, location.href), e ?? {});
}
function lt(t) {
  if (!x() && t.state) {
    location.reload();
  ...
  const e = history.state,
    n = e.index,
    o = n > T ? "forward" : "back";
  (T = n), M(o, g, new URL(location.href), {}, e);
}
const L = () => {
  history.state &&
...
};
{
  if (O || C() !== "none")
    if (
      ...
      addEventListener("popstate", lt),
      addEventListener("load", Y),
      "onscrollend" in window)
    )
      addEventListener("scrollend", L);
    else {
      let t, e, n, o;
      const r = () => {
...
export { G as T, K as a, ut as n, O as s };
